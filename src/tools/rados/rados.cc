...
void usage(ostream &out)
{
    out << "usage: rados [options] [commands]\n"
           ...
           "   put-enc <obj-name> <infile> [--offset offset]\n"
                       ...
                       Formatter &f)
{
    ...
    if ((inc.union_shards.has_info_missing() || inc.union_shards.has_info_corrupted() || inc.has_object_info_inconsistency() || shard.has_obj_size_info_mismatch()) &&
    ...
    if ((inc.union_shards.has_snapset_missing() || inc.union_shards.has_snapset_corrupted() || inc.has_snapset_inconsistency()) &&
    ...
    if ((inc.union_shards.has_hinfo_missing() || inc.union_shards.has_hinfo_corrupted() || inc.has_hinfo_inconsistency()) &&
                             ...
                             std::vector<const char *> &nargs)
{
    ...
    else if (strcmp(nargs[0], "listsnaps") == 0)
    {
             ...
             ci != ls.clones.end(); ++ci)
        {
            ...
            if (formatter)
                formatter->open_object_section("clone");
