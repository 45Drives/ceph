# Install script for directory: /root/ceph/src/crypto/isa-l
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  foreach(file
      ...
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib64/ceph/crypto/libceph_crypto_isal.so"
      )
    if(EXISTS "${file}" AND
       NOT IS_SYMLINK "${file}")
      file(RPATH_CHECK
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib64/ceph/crypto" TYPE SHARED_LIBRARY FILES
    "/root/ceph/lib/libceph_crypto_isal.so.1.0.0"
    "/root/ceph/lib/libceph_crypto_isal.so.1"
    "/root/ceph/lib/libceph_crypto_isal.so"
    )
  foreach(file
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib64/ceph/crypto/libceph_crypto_isal.so.1.0.0"
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib64/ceph/crypto/libceph_crypto_isal.so.1"
