# Install script for directory: /root/ceph/src/pybind/rgw
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
    ...
    set(ENV{CYTHON_BUILD_DIR} "/root/ceph/src/pybind/rgw")
    ...
    execute_process(
       COMMAND
           /bin/python3.6 /root/ceph/src/pybind/rgw/setup.py
           build --verbose --build-base /root/ceph/lib/cython_modules
           --build-platlib /root/ceph/lib/cython_modules/lib.3
           build_ext --cython-c-in-temp --build-temp /root/ceph/src/pybind/rgw --cython-include-dirs /root/ceph/src/pybind/rados
           install ${options} --single-version-externally-managed --record /dev/null
           egg_info --egg-base /root/ceph/src/pybind/rgw
           --verbose
       WORKING_DIRECTORY "/root/ceph/src/pybind/rgw"
